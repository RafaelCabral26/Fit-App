...
export default function MyApp() {
    ...
    return (
        <div>
            ...
            <section className="relative  grid xl:gap-y-12 2xl:gap-y-20 text-white w-full md:h-[80vh] grid-cols-12 grid-rows-6">
                <div className="place-self-center  col-start-2 xl:col-start-2 2xl:col-start-2 col-span-12 xl:col-span-8 2xl:col-span-6  row-start-2 2xl:row-start-3  ">
                ...
                <div className="col-start-2 md:col-start-2 xl:col-start-2 row-start-3 2xl:row-start-4 col-span-9 md:col-span-6 xl:col-span-4 ">
                ...
                <div className="place-self-center justify-self-start md:place-self-start col-start-2  col-span-6  row-start-4 2xl:row-start-5 ">
                    <button className="btn btn-secondary xl:btn-wide rounded-sm">Saiba Mais</button>
                </div>
            </section>
            <section className="container h-[90vh] m-auto border-2 border-red-500">
                Teste
            </section>
        </div>
    )
