...
CREATE TABLE IF NOT EXISTS `exercises` (`exercise_id` CHAR(36) BINARY UNIQUE , `exercise_name` VARCHAR(255) NOT NULL UNIQUE, `muscle_group` VARCHAR(255) NOT NULL, `subgroup` VARCHAR(255), `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, PRIMARY KEY (`exercise_id`));
