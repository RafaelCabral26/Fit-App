...
router.post("/login", (0, tryCatch_1.tryCatch)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ;
    let dbUser = yield user_model_1.default.findOne({ where: { email: userInput.email, active: 1 } });
    if (!dbUser) {
        dbUser = yield trainer_model_1.default.findOne({ where: { email: userInput.email, active: 1 } });
        if (!dbUser)
