          ...
          <div className="flex flex-col justify-evenly">
            ...
            <div className="flex">
              <label className="label gap-2 ">
                <input className="my-checkbox" type="checkbox" checked={userProfile === "user"} onChange={() => setUserProfile("user")} onClick={() => setUserProfile("user")} />
                <span className="label-text text-xs">Praticante</span>
              </label>
              <label className="label gap-2 ">
                <input className="my-checkbox" type="checkbox" checked={userProfile === "trainer"} onChange={() => setUserProfile("trainer")} onClick={() => setUserProfile("trainer")} />
