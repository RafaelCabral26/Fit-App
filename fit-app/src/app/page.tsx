  ...
  return (
    <div className="w-full bg-white ">
      ...
      <section className="relative h-[calc(100vh-3rem)] grid xl:gap-y-12 2xl:gap-y-20  w-full  grid-cols-12 grid-rows-6 ">
        <div className="place-self-center col-start-2 xl:col-start-2 2xl:col-start-2 col-span-12 sm:col-span-10 lg:col-span-6 xl:col-span-8 2xl:col-span-6  row-start-2 sm:col-start-2 lg:col-start-2 xl:row-start-2  ">
        ...
        <div className="col-start-2 md:col-start-2 xl:col-start-2 row-start-3 xl:row-start-3 col-span-9 md:col-span-6 xl:col-span-4 ">
        ...
        <div className=" justify-self-start md:place-self-start col-start-2  col-span-6  row-start-4 xl:row-start-4 ">
      ...
      <div className="flex self-center flex-col md:flex-row items-baseline gap-10 md:gap-36 ">
        <div className="flex flex-col gap-2 ">
          <div className="flex w-full justify-around h-40">
            ...
            <div className="self-center flex flex-col items-start basis-[45%]">
              <span className="text-lg text-primary font-bold font-sans">TREINAMENTO <br />PERSONALIZADO</span>
          ...
          <span className="text-center text-neutral-600 m-4 font-serif ">Nosso software de criação de planilhas de treinos para academia representam uma ferramenta valiosa para  treinadores e atletas, tornando o treinamento mais eficiente e personalizado. </span>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex  w-full justify-around h-40 ">
            ...
            <div className="self-center flex flex-col items-start basis-[45%]">
              <span className="text-lg text-primary font-bold font-sans"> VARIEDADE DE EXERCÍCIOS</span>
              <span className="text-md text-secondary font-semibold font-mono uppercase">CONSULTE OU CRIE<br /> SEUS EXERCÍCIOS</span>
            </div>
          </div>
          <div className="w-[90%] my-4 m-auto h-1 border-b-2 border-neutral-300/50 "></div>
          <span className="text-center  text-neutral-600 m-4 font-serif ">A variedade é a chave para manter o interesse e a motivação durante o treinamento.  Disponibilizamos uma ampla gama de exercícios, permitindo que os clientes explorem diferentes modalidades e técnicas.</span>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex  w-full justify-around h-40 ">
            ...
            <div className="self-center flex flex-col items-start basis-[45%]">
              <span className="text-lg text-primary  font-bold font-sans">MONITORE A <br /> SUA EVOLUÇÃO</span>
          ...
          <span className="text-center  text-neutral-600 m-4 font-serif ">A possibilidade de registrar e acompanhar o progresso  é uma ferramenta valiosa. Isso permite que atletas e treinadores avaliem o desempenho, identifiquem áreas de melhoria e ajustem os planos de treino de acordo.</span>
        </div>
      </div>
    </section>
  )
                  ...
                  <div id="carousel-item" className="flex flex-col items-center w-screen sm:w-full m-auto pb-10  ">
                    <div className="card shadow-md w-full lg:w-96  items-center border-white border-[0.1px] border-opacity-30 ">
                      ...
                      <div className="card-body max-w-fit relative">
                        ...
                        <p className="whitespace-normal text-neutral-600 m-4 ">{item.text}</p>
                      </div>
                    </div>
                  </div>
                </div>
